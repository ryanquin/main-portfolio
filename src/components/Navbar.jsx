...
import logo from "../assets/rq.png";
...
const Navbar = () => {
  ...
  const toggleResume = () => {
    const resumeUrl =
      "https://drive.google.com/file/d/11X4dxuPcbf3Ya_4s2-OqM7W1BeGDn7Yx/view?usp=sharing";
        ...
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-white text-[20px] font-bold cursor-pointer flex">
              Ryan&nbsp;
              <span className="sm:block hidden">Quiñones</span>
            </p>
          </Link>
